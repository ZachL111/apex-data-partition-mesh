"""Regression checks for the apex-data-partition-mesh casebook."""
...
from casebook.harness import assert_expected, apex_data_partition_mesh_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(apex_data_partition_mesh_summary(), assert_expected())
